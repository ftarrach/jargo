  ...
  public static List<JargoRoundtripTestArguments> get() {
    return List.of(
        new JargoRoundtripTestArguments("primitives", """
            {"_byte":42,"_char":"f","_short":42,"_int":42,"_long":42,"_double":42.42,"_boolean":true,"string":"text"}""", new TestValues.Rec.WrappedValueRecord(
            new TestValues.WrappedValue.WrappedByteValue(new TestValues.Value.ByteValue((byte) 42)),
            new TestValues.WrappedValue.WrappedCharValue(new TestValues.Value.CharValue('f')),
            new TestValues.WrappedValue.WrappedShortValue(new TestValues.Value.ShortValue((short) 42)),
